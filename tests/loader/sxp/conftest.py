...
def fixture_h5_file():
    ...
    """
    return h5py.File(os.path.join(package_dir, f"../tests/data/loader/sxp/{H5_PATH}"), "r")
...
def fixture_h5_file_copy(tmp_path):
    ...
    original_file_path = os.path.join(package_dir, f"../tests/data/loader/sxp/{H5_PATH}")
